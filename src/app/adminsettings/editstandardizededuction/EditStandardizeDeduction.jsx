...
const EditStandardizeDeduction = () => {
  ...
  return (
    <>
      <Back onClick={BackClick} text={"Edit Standard Deduction Rate"} />
      <Breadcrumb
        paths={[
          { name: "Admin Settings", route: "/adminsettings" },
          { name: "Edit Standard Deduction Rate" },
        ]}
      />
      <div>
        <form onSubmit={handleSubmit}>
          ...
          <div className={style.EditMainDivTaxableIncomeRange}>
            <div className={style.HedingMainDiv}>
              <HeadingTextH1 text={"Standard Deduction Rate"} className={style.Headingtext}/>
            </div>
...
export default EditStandardizeDeduction;
